...
def getArgs():
    ...
    parser.add_argument('--feature_size', type=int, default=10,help="num of channels of feature map")
    ...
    parser.add_argument('--threshold', type=float, default=0.9,help="threshold of test output,point is omitted if gray(point)<max_gray*threshold")
    parser.add_argument('--detector_num', type=int, default=2,help="number of detectors to use in [corners,edges,circles]")
